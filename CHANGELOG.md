...
- **actions**: safely update full SHA pins with verified concrete version comments
- **actions**: update tagged reusable workflow references alongside actions
- **automation**: add a policy-constrained reusable workflow for grouped Actions pull requests
- **output**: report immutable-ref commit details and safety-blocked updates in JSON
