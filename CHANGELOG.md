...
- **nix**: update flake.lock inputs ([c987929](https://github.com/rvben/upd/commit/c987929812bba0e5bbc05cc20de2f399bd3c9852))
- **lockfile**: add explicit transitive lock refresh ([2d61c84](https://github.com/rvben/upd/commit/2d61c84d39c6b56d0c02bc4701e9c825f630c0e6))

### Fixed

- **gitlab**: preserve human commits on automation branches ([469fb7e](https://github.com/rvben/upd/commit/469fb7ea88ca0d86e3cd30a103d412ce3df31386))
- **align**: report only the edits the writer would actually make ([0ff159a](https://github.com/rvben/upd/commit/0ff159ad7b7c9bbe9ff7c0a399fac6eca32b2ce2))

## [0.13.0](https://github.com/rvben/upd/compare/v0.12.4...v0.13.0) - 2026-09-16

### Added

- **cooldown**: keep --lock refreshes to the cooldown ([f011c71](https://github.com/rvben/upd/commit/f011c71484bdef5a30b36cb43b896335937b2706))
...
- **python**: read PEP 440 arbitrary equality as one operator ([9643c30](https://github.com/rvben/upd/commit/9643c30f1f33e799563e39c8b706e347ba566a0b))
...
## [0.10.2](https://github.com/rvben/upd/compare/v0.10.1...v0.10.2) - 2026-09-03

### Fixed

- **release**: validate only existing workflows while synchronizing release pins
...
- **pyproject**: add specifier normalization policies ([cd27015](https://github.com/rvben/upd/commit/cd270154125f618f4b78fb4a9a566eb8c13f62b2))

## [0.9.2](https://github.com/rvben/upd/compare/v0.9.1...v0.9.2) - 2026-09-01

### Fixed

- **lockfiles**: run lockfile tools in the current directory for bare manifest paths ([bee32a3](https://github.com/rvben/upd/commit/bee32a3130aca1092361d0a1c3beaa67fa485d40))

## [0.9.1](https://github.com/rvben/upd/compare/v0.9.0...v0.9.1) - 2026-08-31

### Added

- **docker**: authenticate private GHCR tag lookups with repository-scoped GitHub Actions credentials

### Fixed

- **lockfiles**: isolate targeted regeneration when several ecosystems share a directory

## [0.9.0](https://github.com/rvben/upd/compare/v0.8.8...v0.9.0) - 2026-08-31
